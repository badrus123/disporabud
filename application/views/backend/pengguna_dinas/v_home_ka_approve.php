    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <!-- <li>
                    <a href="<?php echo base_url() ?>c_disporabud/index"><i class="fa envelope-open-o">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level collapse">
                        <li>
                            <a href="<?php echo base_url() ?>c_disporabud/index">Belum di Approve</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>c_disporabud/sudahApproveKA">Sudah di Approve</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="<?php echo base_url() ?>c_disporabud/laporan"><i class="fa fa-book">
                    </i> <span class="nav-label">Laporan</span></a>
                </li>
                <!-- <li>
                ...
                <div class="modal-content animated bounceInRight">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-white" data-dismiss="modal">Close</button>
                                        ...
                                        <td>
                                            <?php if ($this->session->status_approval == 'belum') { ?>
                                            <a href="<?php echo base_url() ?>c_disporabud/approveKA?id=<?php echo $d->id_transaksi ?>">
                                                <button class="btn btn-primary">Approve Pengajuan</button>
                                            </a>
                                            <?php } else { ?>
                                                <button class="btn btn-primary">Sudah Di Approve</button>
                                            <?php } ?>
                                        </td>
                                    </tr>
                                <?php } ?>
